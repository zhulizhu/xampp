...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="tab" id="tab">
            <a href="open_admire.html">
                <div class="pull-left">开启赞赏功能</div>
                <div class="pull-right clo" style="padding: 18px">已关闭<img src="/playChat/Public/Home/images/kaiqiguanbi2.png"></div>
            </a>
        </div>
