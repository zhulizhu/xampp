    ...
    <div class="container-fluid">
        ...
        <div class="row" style="padding-left:0;padding-right: 0;">
            ...
            <div class="col-xs-4">
                ...
                <h4>收费直播</h4>
                <div ><img style="width: 76%;height: auto"  src="/playChat/Public/Home/images/shouferizhibo1.png"></div>
                </a>
                <p style="left: 42%">
            ...
            <form class="form-inline">
                <div class="form-group">
                    <div class="input-group">
                        <input type="text" class="form-control" id="exampleInputAmount" placeholder="请输入金额(最低1元)">
